...
class AdminController extends Controller
{
        ...
        public function dashboard(Request $request){
            $pendingtrades = Trade::where('trade_status', 'pending')->count();
            $completedtrades = Trade::where('trade_status', 'success')->count();
    
            $details = array("pendingtrades"=>$pendingtrades, "completedtrades"=>$completedtrades);
            ...
            $pendingtrades = Trade::where('trade_status', 'pending')->get();
    
            return view('admin.dashboard')->with(compact('details', 'pendingtrades'));
        }
